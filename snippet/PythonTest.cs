...
namespace PythonTest
{
    class PythonTestProgram
    {
        ...
        public PythonTestProgram()
        {
            ...
            // python環境にパスを通す
            // TODO: 環境に合わせてパスを直すこと
            var PYTHON_HOME = Environment.ExpandEnvironmentVariables(@"C:\Users\stj\anaconda3\envs\opencv400");

            // pythonnetが、python本体のDLLおよび依存DLLを見つけられるようにする
            AddEnvPath(
              PYTHON_HOME,
              Path.Combine(PYTHON_HOME, @"C:\Users\stj\anaconda3\Library\bin")
            );
            ...
            PythonEngine.PythonPath = string.Join(
              ...
              new string[] {
                  ...
                  Path.Combine(PYTHON_HOME, @"C:\Users\stj\anaconda3\Lib\site-packages"), //pipで入れたパッケージはここに入る
                  Path.Combine(@"E:\Repository\STEREOCAM_commit\CSharp\StereoCameraDemoApp\StereoCameraDemoApp\lib"), //自分で作った(動かしたい)pythonプログラムの置き場所も追加
              }
            );
            ...
            using (Py.GIL())
            {
                ...
                // 自作コードも叩ける
                dynamic myMath = Py.Import("my_math"); // "from my_awesome_lib import my_math"
