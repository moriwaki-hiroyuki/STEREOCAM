...
"""
PATTERN_SIZE = (7, 10)
IMAGE_PATH = "F:\\Repository\\STEREOCAM_commit\\CSharp\\StereoCameraDemoApp\\StereoCameraDemoApp\\Images\\calibration\\*"
...
fw = open(CALIBRATION_FILEPATH + CALIBRATION_DATA_FILENAME, 'w')
